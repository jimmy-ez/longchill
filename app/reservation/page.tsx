...
const ADJACENCY_MAP: Record<string, string[]> = {
    // T Horizontal
    "T5": ["T6"], "T10": ["T9", "T11"], "T15": ["T14", "T16"], "T20": ["T19"], "T24": ["T8"],
    "T4": ["T3", "T23"], "T9": ["T10"], "T14": ["T13", "T15"], "T19": ["T18", "T20"], "T23": ["T4"],
    "T3": ["T2", "T4"], "T8": ["T7", "T24"], "T13": ["T14"], "T18": ["T17", "T19"],
    "T2": ["T1", "T3"], "T7": ["T6", "T8"], "T12": ["T11"], "T17": ["T18"],
    "T1": ["T2"], "T6": ["T5", "T7"], "T11": ["T10", "T12"], "T16": ["T15"],
    "T21": ["T22"], "T22": ["T21"],
    // V Vertical
    "V3": ["V2"], "V2": ["V3", "V1"], "V1": ["V2"],
    "V6": ["V5"], "V5": ["V4", "V6"], "V4": ["V5"],
    "V8": ["V7"], "V7": ["V8"],
